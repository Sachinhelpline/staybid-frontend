# ChatGPT Prompts — Phase 1 & Phase 2 Workflows + Role-Based Responsibility Assignment

**How to use these prompts:**
1. Copy the prompt for your role
2. Paste into ChatGPT (GPT-4 recommended)
3. Request: "Generate a Mermaid flowchart" or "Create a responsibility matrix"
4. Export as image/PNG or copy Mermaid code into a .md file

---

## PROMPT 1: Project Manager / Launch Lead
### Phase 1 & Phase 2 Timeline + Dependency Map
...
- Visual gate decisions (Sep 25, Oct 1)
...
## PROMPT 2: Tech Lead
### System Architecture + Cron Workflow (Phase 1 → Phase 2)
...
**What to expect:**
- Detailed cron workflow diagram
- PASS 1 / PASS 2 logic flow
- Phase 1 → Phase 2 transition point
- Error scenarios + handling
- RazorpayX integration diagram

---

## PROMPT 3: Ops Lead / Launch Coordinator
### Phase 1 & Phase 2 Responsibilities + Daily Workflow
...
**What to expect:**
- Daily/hourly phase 1 checklist
- Role breakdown (RACI matrix)
- Phase 2 scaling workflow
- Handoff points and sign-offs
- Escalation paths

---

## PROMPT 4: Investor Relations Lead
### Phase 1 & Phase 2 Investor Journey + Nurture Workflows
...
**What to expect:**
- Investor funnel visualization
- 7-step journey flowchart
- Communication touchpoint calendar
- Phase 2 scaling roadmap
- Drop-off analysis points

---

## PROMPT 5: Finance / Payout Lead
### Settlement Ledger + Payout Workflow (Phase 1 → Phase 2)
...
**What to expect:**
- Manual payout workflow (Phase 1)
- RazorpayX automation flow (Phase 2)
...
### Phase 1 & Phase 2 Property-Level Operations
...
**What to expect:**
- Property manager daily checklist (Phase 1 & 2)
- Booking response workflow
- Payout transparency view
- Phase 2 pricing feature workflow
- Communication templates

---

## PROMPT 7: Admin / Super Admin
### Phase 1 & Phase 2 Admin Controls + Oversight
...
**What to expect:**
- Validation checklist (Sep 25 gate)
- Phase 2 feature rollout timeline
...
1. **Pick your role** from the 7 prompts above
2. **Copy the entire prompt** (starting with "I'm launching..." or "I'm leading...")
3. **Paste into ChatGPT** (visit chat.openai.com, use GPT-4 if available)
4. **Request format:**
   - "Generate a Mermaid flowchart" → Copy the Mermaid code, save as `.md` file or render in an online editor
   - "Create a visual diagram" → ChatGPT will describe the diagram; request it again with "Export as SVG" or save the description
   - "Make a responsibility matrix" → Copy the table/CSV output
5. **Save outputs** to your local folder or shared drive
6. **Share with your team** — print or embed in Confluence/Notion

---

## Expected Outputs Per Role

| Role | Output | Format | Use Case |
|------|--------|--------|----------|
| **Project Lead** | Timeline + dependency map | Gantt/Flowchart | Stakeholder updates, exec briefing |
| **Tech Lead** | Cron workflow + RazorpayX integration | Swimlane diagram | Engineering spec, code planning |
| **Ops Lead** | Daily checklist + RACI matrix | Checklist + table | Team onboarding, task assignment |
| **Investor Ops** | Funnel + journey map | Funnel chart | Marketing material, investor comms |
| **Finance Lead** | Payout workflow + reconciliation | Swimlane + flowchart | Audit, RazorpayX integration |
| **Property Mgr** | Daily checklist + dashboard mockup | Checklist + screenshot | Day-to-day operations |
| **Admin** | Validation gate + feature rollout | Checklist + timeline | Sep 25 decision, Phase 2 rollout |

---

## Notes

- All prompts assume Phase 1 launch Aug 20, Phase 2 start Oct 1
- Customize investor counts, property names, revenue targets based on your actual plan
- For role-specific customizations, append to the prompt: "Our property is [name], we have [N] units, and we're targeting [X] occupancy in Phase 1."
- Save all outputs to `/docs` in your repo for team access
