         ...
         <TierProvider>
          <SoundProvider>
           <FollowProvider>
            ...
            <div style={{position:"fixed",bottom:"68px",right:"6px",zIndex:9999,fontSize:"8px",padding:"1px 5px",borderRadius:"999px",background:"rgba(201,166,107,0.14)",color:"rgba(201,166,107,0.75)",border:"1px solid rgba(201,166,107,0.30)",pointerEvents:"none",fontFamily:"monospace",letterSpacing:"0.05em"}}>v596</div>
            </TutorialProvider>
            </PostsProvider>
           </FollowProvider>
          </SoundProvider>
...
var SB_BUILD="v596-dusty-slate-blue-accent";
