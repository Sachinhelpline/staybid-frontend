         ...
         <TierProvider>
          <SoundProvider>
           <FollowProvider>
            ...
            <div style={{position:"fixed",bottom:"68px",right:"6px",zIndex:9999,fontSize:"8px",padding:"1px 5px",borderRadius:"999px",background:"rgba(106,133,160,0.14)",color:"rgba(106,133,160,0.75)",border:"1px solid rgba(106,133,160,0.30)",pointerEvents:"none",fontFamily:"monospace",letterSpacing:"0.05em"}}>v633</div>
            </TutorialProvider>
            </PostsProvider>
           </FollowProvider>
          </SoundProvider>
...
var SB_BUILD="v633-depth-rebuilt-perfect";
