        ...
        <AuthProvider>
          <SoundProvider>
           <FollowProvider>
            ...
            <div style={{position:"fixed",bottom:"4px",right:"6px",zIndex:9999,fontSize:"8px",padding:"1px 5px",borderRadius:"999px",background:"rgba(240,180,41,0.12)",color:"rgba(240,180,41,0.7)",border:"1px solid rgba(240,180,41,0.25)",pointerEvents:"none",fontFamily:"monospace",letterSpacing:"0.05em"}}>v32</div>
            </PostsProvider>
           </FollowProvider>
          </SoundProvider>
        </AuthProvider>
...
var SB_BUILD="v32-audio-isolation-close-flash-2026-05-05";
try{
