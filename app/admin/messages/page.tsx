            ...
            {convos.map((c) => {
              ...
              return (
                <button key={c.bid_id} onClick={() => openConvo(c)}
                  ...
                  <div style={{ width: 36, height: 36, borderRadius: 999, background: "linear-gradient(135deg,#9fb1c2,#c6d0da)", color: "#0F1117", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 700, flexShrink: 0 }}>
