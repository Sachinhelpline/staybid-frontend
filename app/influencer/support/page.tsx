...
// Creator Support — raise a ticket + 2-way chat with StayBid HQ (unified HQ Support Desk).
  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "20px 16px 96px" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
        <Link href="/influencer" style={{ fontSize: 20, color: "#888", textDecoration: "none" }} aria-label="Back">←</Link>
        <h1 style={{ fontSize: 20, fontWeight: 700, color: "#222", margin: 0 }}>Support</h1>
      </div>
      <SupportDeskPanel
        apiBase="/api/influencer/support"
        tokenKey="sb_token"
        accent="#7c3aed"
