  ...
  return (
    <div className="min-h-screen bg-luxury-50 pdash-root">
      <style>{`
        ...
        .btn-gold { background:linear-gradient(135deg,#8198ae,#a9b9c8); color:#fff; border:none; border-radius:9px; padding:8px 15px; font-weight:700; cursor:pointer; font-size:0.8rem; transition:all 0.18s; box-shadow:0 2px 8px rgba(106, 133, 160,0.22); }
      ...
      <div className="bg-white/95 backdrop-blur-sm border-b border-luxury-200 sticky top-[56px] z-30 overflow-x-auto"
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-5 flex gap-1 py-1.5">
          {TABS.map((t: any) => {
            ...
            const style = active
              ? { background:"linear-gradient(135deg,#8198ae,#a9b9c8)", boxShadow:"0 2px 8px rgba(106, 133, 160,0.3)" }
              : undefined;
            const inner = (
              <>
