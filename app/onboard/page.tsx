      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/onboard/signup" className="px-7 py-3.5 rounded-full bg-linear-to-r from-gold-600 to-gold-500 text-white font-semibold shadow-gold hover:shadow-xl transition">Start onboarding →</Link>
          ...
          <div className="mt-10 grid grid-cols-3 gap-4 text-center">
            {[
              ...
              <div key={s.l} className="rounded-2xl bg-white border border-luxury-100 p-4 shadow-xs">
      ...
      <div className="mt-24">
        ...
        <div className="grid md:grid-cols-4 gap-5">
          {[
            ...
            <div key={s.n} className="rounded-2xl bg-white border border-luxury-100 p-6 shadow-xs hover:shadow-md transition">
