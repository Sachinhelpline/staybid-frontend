    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="space-y-4 mb-8">
        {hotel.rooms?.map((r: any) => (
          <div key={r.id} className={`p-5 rounded-2xl border transition ${bidRoom?.id === r.id ? "border-brand-500 bg-brand-50" : "border-gray-100 bg-white hover:border-gray-200"}`}>
          ...
          <div className="bg-white w-full sm:max-w-md rounded-t-3xl sm:rounded-3xl p-6" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mb-5">
              ...
              <textarea
                ...
                placeholder="e.g. Planning anniversary trip, need best deal..."
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={handleBid}
                disabled={bidLoading || !bidAmount || parseFloat(bidAmount) < bidRoom.floorPrice}
                className="flex-1 py-3 rounded-xl bg-brand-600 text-white font-bold hover:bg-brand-700 transition disabled:opacity-40"
              >
