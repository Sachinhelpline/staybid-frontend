                  ...
                  <div>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 10 }}>
                      ...
                      <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                        <button onClick={() => bridgeToPartnerDashboard(user, "myrooms")}
                          style={{ fontSize: ".72rem", fontWeight: 800, padding: "6px 13px", borderRadius: 999, border: 0, background: "linear-gradient(135deg,#8198ae,#a9b9c8)", color: "#1f1710", cursor: "pointer" }}>
                          ⇄ List on exchange
                        </button>
                        <button onClick={() => bridgeToPartnerDashboard(user, "agentauction")}
