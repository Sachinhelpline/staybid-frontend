    ...
    <div className="sb-card-lift h-full rounded-2xl overflow-hidden flex flex-col"
      ...
      <div className="p-3 flex flex-col flex-1">
        ...
        <button onClick={() => onAdd(p, mode)}
          ...
          style={{ background: "radial-gradient(88% 64% at 32% 4%,rgba(240,247,253,0.24),transparent 58%),linear-gradient(160deg,#a0b2c6 0%,#6f8aa6 50%,#42566d 100%)" }}>Add to cart</button>
      </div>
    </div>
  );
}
        ...
        {status === "done" ? (
          <div className="text-center py-8">
            ...
            <button onClick={onClear} className="mt-5 px-6 py-2.5 rounded-full text-white font-semibold"
              style={{ background: "radial-gradient(88% 64% at 32% 4%,rgba(240,247,253,0.24),transparent 58%),linear-gradient(160deg,#a0b2c6 0%,#6f8aa6 50%,#42566d 100%)" }}>Continue shopping</button>
          </div>
        ) : (
          <>
