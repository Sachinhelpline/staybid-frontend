...
const CITY_DATA: Record<string, { emoji: string; photo: string; avg: number; demand: "Very High" | "High" | "Medium" | "Low"; demandColor: string; tip: string; state: string; tags: string[] }> = {
  Mussoorie:  { emoji: "🏔️", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Mussoorie_Snow_Over_Dehradun_%2814831297545%29.jpg/330px-Mussoorie_Snow_Over_Dehradun_%2814831297545%29.jpg", avg: 3200, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Weekend & holiday peak — bid early for best rates!",  state: "Uttarakhand",       tags: ["Hill Station", "Honeymoon", "Nature"] },
  Dhanaulti:  { emoji: "🌲", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/Dhanaulti_2.jpg/330px-Dhanaulti_2.jpg", avg: 2800, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Weekdays offer up to 25% better deals here.",         state: "Uttarakhand",       tags: ["Forest", "Peaceful", "Couples"] },
  Rishikesh:  { emoji: "🕉️", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/74/Trayambakeshwar_Temple_VK.jpg/330px-Trayambakeshwar_Temple_VK.jpg", avg: 2400, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Yoga retreat season — adventure packages popular.",   state: "Uttarakhand",       tags: ["Adventure", "Spiritual", "Yoga"] },
  Shimla:     { emoji: "❄️", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Landscape_of_Shimla_%2C_Himachal_Pradesh.jpg/330px-Landscape_of_Shimla_%2C_Himachal_Pradesh.jpg", avg: 3500, demand: "Very High", demandColor: "text-red-600    bg-red-50    border-red-200",    tip: "Peak hill-station demand — book ahead for savings.",  state: "Himachal Pradesh",  tags: ["Snow", "Heritage", "Family"] },
  Manali:     { emoji: "🏂", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Manali_City.jpg/330px-Manali_City.jpg", avg: 3800, demand: "Very High", demandColor: "text-red-600    bg-red-50    border-red-200",    tip: "Adventure season — premium pricing, bid smart.",      state: "Himachal Pradesh",  tags: ["Skiing", "Adventure", "Honeymoon"] },
  Dehradun:   { emoji: "🌿", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Dehradun_view_from_maggi_point.jpg/330px-Dehradun_view_from_maggi_point.jpg", avg: 2200, demand: "Low",       demandColor: "text-emerald-600 bg-emerald-50 border-emerald-200", tip: "Low season — great deals & immediate accepts!",    state: "Uttarakhand",       tags: ["Gateway", "Business", "Budget"] },
  // ── v577 — full launch-city coverage (every city in lib/launch/curation.ts
  //    LAUNCH_HOTEL_BY_CITY). Photos use the picsum-seed source (same as the
  //    tile onError fallback) so a tile is never broken; swap in curated shots
  //    later. avg is a plausible per-city ADR for the bid-strength anchor.
  Kanatal:      { emoji: "🏕️", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Kanatal.jpg/330px-Kanatal.jpg",     avg: 2600, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Quiet camps & apple country — weekdays are cheapest.", state: "Uttarakhand",       tags: ["Camping", "Nature", "Quiet"] },
  Nainital:     { emoji: "🚣", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Nainital_metro.jpg/330px-Nainital_metro.jpg",    avg: 3000, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Lake-town peak on weekends — bid early to save.",      state: "Uttarakhand",       tags: ["Lake", "Family", "Boating"] },
  Bhimtal:      { emoji: "🌊", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Bhimtal_lake_view_01.jpg/330px-Bhimtal_lake_view_01.jpg",     avg: 2400, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Calmer than Nainital — great mid-week value.",         state: "Uttarakhand",       tags: ["Lake", "Peaceful", "Nature"] },
  Mukteshwar:   { emoji: "🍎", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Chauli_Ki_Jali%2C_Mukteshwar.jpg/330px-Chauli_Ki_Jali%2C_Mukteshwar.jpg",  avg: 2600, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Orchard views & quiet stays — easy accepts off-peak.", state: "Uttarakhand",       tags: ["Orchards", "Views", "Quiet"] },
  Lansdowne:    { emoji: "🌲", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Lansdowne_Landscape.jpg/330px-Lansdowne_Landscape.jpg",   avg: 2500, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Pine-cantonment calm — weekdays give the best rates.", state: "Uttarakhand",       tags: ["Pine", "Cantonment", "Quiet"] },
  Corbett:      { emoji: "🐯", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Bengal-Tiger_Corbett_Uttarakhand_Dec-2013.jpg/330px-Bengal-Tiger_Corbett_Uttarakhand_Dec-2013.jpg",     avg: 3200, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Safari season lifts prices — bid ahead of weekends.",  state: "Uttarakhand",       tags: ["Wildlife", "Safari", "Jungle"] },
  Haridwar:     { emoji: "🛕", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/Ganga_aarti_haridwar_01.jpg/330px-Ganga_aarti_haridwar_01.jpg",    avg: 1800, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Pilgrim demand spikes on festivals — bid early.",      state: "Uttarakhand",       tags: ["Spiritual", "Ganga", "Pilgrimage"] },
  Kasol:        { emoji: "🎒", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Kasol_mountain_view.jpg/330px-Kasol_mountain_view.jpg",       avg: 2200, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Parvati-valley backpacker rates — great mid-week.",    state: "Himachal Pradesh",  tags: ["Backpacker", "Parvati", "Trek"] },
  Kasauli:      { emoji: "🌄", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/Kasauli_hills.jpg/330px-Kasauli_hills.jpg",     avg: 2800, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Colonial hill calm — weekends peak, weekdays save.",   state: "Himachal Pradesh",  tags: ["Colonial", "Pine", "Couples"] },
  Chail:        { emoji: "🌲", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Chailhill.jpg/330px-Chailhill.jpg",       avg: 2600, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Quiet palace town — easy accepts on weekdays.",        state: "Himachal Pradesh",  tags: ["Quiet", "Palace", "Forest"] },
  Dharamshala:  { emoji: "☸️", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Dharamshala_03_%28Cropped%29.jpg/330px-Dharamshala_03_%28Cropped%29.jpg", avg: 2800, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "McLeodganj demand peaks in season — bid early.",       state: "Himachal Pradesh",  tags: ["Monastery", "Views", "Trek"] },
  "Bir Billing":{ emoji: "🪂", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/An_aerial_view_of_Bir%2C_Kangra_valley_sights_nature_culture_Himachal_Pradesh_India_2015.jpg/330px-An_aerial_view_of_Bir%2C_Kangra_valley_sights_nature_culture_Himachal_Pradesh_India_2015.jpg",  avg: 2600, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Paragliding season lifts rates — weekdays are best.",  state: "Himachal Pradesh",  tags: ["Paragliding", "Adventure", "Cafes"] },
  Jaipur:       { emoji: "🕌", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/East_facade_Hawa_Mahal_Jaipur_from_ground_level_%28July_2022%29_-_img_01.jpg/330px-East_facade_Hawa_Mahal_Jaipur_from_ground_level_%28July_2022%29_-_img_01.jpg",      avg: 3500, demand: "Very High", demandColor: "text-red-600    bg-red-50    border-red-200",    tip: "Pink-city peak — bid smart on heritage stays.",        state: "Rajasthan",         tags: ["Heritage", "Palace", "Culture"] },
  Udaipur:      { emoji: "🛶", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Evening_view%2C_City_Palace%2C_Udaipur.jpg/330px-Evening_view%2C_City_Palace%2C_Udaipur.jpg",     avg: 4200, demand: "Very High", demandColor: "text-red-600    bg-red-50    border-red-200",    tip: "Lake-palace romance runs premium — bid early.",        state: "Rajasthan",         tags: ["Lakes", "Romance", "Palace"] },
  Jaisalmer:    { emoji: "🐪", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/Jaisalmer_Fort.jpg/330px-Jaisalmer_Fort.jpg",   avg: 3800, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Desert-camp season peaks in winter — bid ahead.",      state: "Rajasthan",         tags: ["Desert", "Fort", "Camp"] },
  Pushkar:      { emoji: "🎡", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Pushkar.jpg/330px-Pushkar.jpg",     avg: 2600, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Fair season spikes prices — weekdays otherwise save.", state: "Rajasthan",         tags: ["Fair", "Spiritual", "Lake"] },
  Neemrana:     { emoji: "🏰", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Neemrana_Fort_Palace_terrace_and_the_town_below.jpg/330px-Neemrana_Fort_Palace_terrace_and_the_town_below.jpg",    avg: 4000, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Weekend fort-palace getaway — bid early for value.",   state: "Rajasthan",         tags: ["Fort", "Heritage", "Weekend"] },
  Goa:          { emoji: "🏖️", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fc/BeachFun.jpg/330px-BeachFun.jpg",         avg: 4000, demand: "Very High", demandColor: "text-red-600    bg-red-50    border-red-200",    tip: "Beach-season premium — bid smart on peak weekends.",   state: "Goa",               tags: ["Beach", "Nightlife", "Party"] },
  Kerala:       { emoji: "🌴", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Boathouse_%287063399547%29.jpg/330px-Boathouse_%287063399547%29.jpg",      avg: 3500, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Backwater season lifts rates — bid ahead of holidays.",state: "Kerala",            tags: ["Backwaters", "Houseboat", "Nature"] },
  Coorg:        { emoji: "☕", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/17/Tadiandamol_Valley%2C_Western_Ghats.jpg/330px-Tadiandamol_Valley%2C_Western_Ghats.jpg",       avg: 3000, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Coffee-country calm — weekdays give the best deals.",  state: "Karnataka",         tags: ["Coffee", "Hills", "Nature"] },
  Leh:          { emoji: "🏔️", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Leh_City_seen_from_Shanti_Stupa.JPG/330px-Leh_City_seen_from_Shanti_Stupa.JPG",         avg: 3200, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Short high-altitude season — bid early in summer.",    state: "Ladakh",            tags: ["Mountains", "Monastery", "Adventure"] },
  Mathura:      { emoji: "🪈", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Vishram_Ghat.jpg/330px-Vishram_Ghat.jpg",     avg: 1900, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Pilgrim town — festival dates peak, else great value.",state: "Uttar Pradesh",     tags: ["Spiritual", "Krishna", "Temples"] },
  Vrindavan:    { emoji: "🙏", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/Iskon_Temple%2C_Vrindawan.jpg/330px-Iskon_Temple%2C_Vrindawan.jpg",   avg: 2000, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Temple-town demand spikes on festivals — bid early.",  state: "Uttar Pradesh",     tags: ["Spiritual", "Temples", "Pilgrimage"] },
  Ayodhya:      { emoji: "🛕", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/Shri_Ram_Janambhoomi_Mandir%2C_Ayodhya_Dham.jpg/330px-Shri_Ram_Janambhoomi_Mandir%2C_Ayodhya_Dham.jpg",     avg: 2200, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "High pilgrim demand — bid early for the best rates.",  state: "Uttar Pradesh",     tags: ["Spiritual", "Ram Mandir", "Pilgrimage"] },
  Varanasi:     { emoji: "🪔", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Dasaswamedh_ghat-varanasi_india-andres_larin.jpg/330px-Dasaswamedh_ghat-varanasi_india-andres_larin.jpg",    avg: 2400, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Ghat-side stays peak on festivals — bid ahead.",       state: "Uttar Pradesh",     tags: ["Ghats", "Spiritual", "Ganga"] },
};
...
export default function BidPage() {
  ...
  // v577 — city picker: search + "show all" toggle so every launch city is
  // reachable (was hard-capped at the 6 featured tiles).
  ...
  const step1Cards: BidCard[] = [
    {
      ...
      render: () => {
        // v577 — every launch city is now selectable. Default view shows the
        // FEATURED tiles + a "Show all" toggle; a search box filters the full
        // list so a traveller can jump straight to any city.
        const q = citySearch.trim().toLowerCase();
        const allCities = Object.entries(CITY_DATA);
        const FEATURED = 6;
        const matches = q
          ? allCities.filter(([n, i]) =>
              n.toLowerCase().includes(q) || i.state.toLowerCase().includes(q) ||
              i.tags.some((t) => t.toLowerCase().includes(q)))
          : allCities;
        const expanded = showAllCities || !!q;
        const shown = expanded ? matches : matches.slice(0, FEATURED);
        const hiddenCount = allCities.length - FEATURED;
        return (
        <>
          ...
          {/* v577 — no match + show-all/less toggle */}
          {q && matches.length === 0 && (
            <p className="bgz-city-none">No city matches “{citySearch}”. Try another name.</p>
          )}
          {!q && hiddenCount > 0 && (
            <button
              type="button"
