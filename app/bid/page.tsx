...
const CITY_DATA: Record<string, { emoji: string; photo: string; avg: number; demand: "Very High" | "High" | "Medium" | "Low"; demandColor: string; tip: string; state: string; tags: string[] }> = {
  ...
  Kanatal:      { emoji: "🏕️", photo: "https://picsum.photos/seed/Kanatal/240/240",     avg: 2600, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Quiet camps & apple country — weekdays are cheapest.", state: "Uttarakhand",       tags: ["Camping", "Nature", "Quiet"] },
  Nainital:     { emoji: "🚣", photo: "https://picsum.photos/seed/Nainital/240/240",    avg: 3000, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Lake-town peak on weekends — bid early to save.",      state: "Uttarakhand",       tags: ["Lake", "Family", "Boating"] },
  Bhimtal:      { emoji: "🌊", photo: "https://picsum.photos/seed/Bhimtal/240/240",     avg: 2400, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Calmer than Nainital — great mid-week value.",         state: "Uttarakhand",       tags: ["Lake", "Peaceful", "Nature"] },
  Mukteshwar:   { emoji: "🍎", photo: "https://picsum.photos/seed/Mukteshwar/240/240",  avg: 2600, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Orchard views & quiet stays — easy accepts off-peak.", state: "Uttarakhand",       tags: ["Orchards", "Views", "Quiet"] },
  Lansdowne:    { emoji: "🌲", photo: "https://picsum.photos/seed/Lansdowne/240/240",   avg: 2500, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Pine-cantonment calm — weekdays give the best rates.", state: "Uttarakhand",       tags: ["Pine", "Cantonment", "Quiet"] },
  Corbett:      { emoji: "🐯", photo: "https://picsum.photos/seed/Corbett/240/240",     avg: 3200, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Safari season lifts prices — bid ahead of weekends.",  state: "Uttarakhand",       tags: ["Wildlife", "Safari", "Jungle"] },
  Haridwar:     { emoji: "🛕", photo: "https://picsum.photos/seed/Haridwar/240/240",    avg: 1800, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Pilgrim demand spikes on festivals — bid early.",      state: "Uttarakhand",       tags: ["Spiritual", "Ganga", "Pilgrimage"] },
  Kasol:        { emoji: "🎒", photo: "https://picsum.photos/seed/Kasol/240/240",       avg: 2200, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Parvati-valley backpacker rates — great mid-week.",    state: "Himachal Pradesh",  tags: ["Backpacker", "Parvati", "Trek"] },
  Kasauli:      { emoji: "🌄", photo: "https://picsum.photos/seed/Kasauli/240/240",     avg: 2800, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Colonial hill calm — weekends peak, weekdays save.",   state: "Himachal Pradesh",  tags: ["Colonial", "Pine", "Couples"] },
  Chail:        { emoji: "🌲", photo: "https://picsum.photos/seed/Chail/240/240",       avg: 2600, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Quiet palace town — easy accepts on weekdays.",        state: "Himachal Pradesh",  tags: ["Quiet", "Palace", "Forest"] },
  Dharamshala:  { emoji: "☸️", photo: "https://picsum.photos/seed/Dharamshala/240/240", avg: 2800, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "McLeodganj demand peaks in season — bid early.",       state: "Himachal Pradesh",  tags: ["Monastery", "Views", "Trek"] },
  "Bir Billing":{ emoji: "🪂", photo: "https://picsum.photos/seed/BirBilling/240/240",  avg: 2600, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Paragliding season lifts rates — weekdays are best.",  state: "Himachal Pradesh",  tags: ["Paragliding", "Adventure", "Cafes"] },
  Jaipur:       { emoji: "🕌", photo: "https://picsum.photos/seed/Jaipur/240/240",      avg: 3500, demand: "Very High", demandColor: "text-red-600    bg-red-50    border-red-200",    tip: "Pink-city peak — bid smart on heritage stays.",        state: "Rajasthan",         tags: ["Heritage", "Palace", "Culture"] },
  Udaipur:      { emoji: "🛶", photo: "https://picsum.photos/seed/Udaipur/240/240",     avg: 4200, demand: "Very High", demandColor: "text-red-600    bg-red-50    border-red-200",    tip: "Lake-palace romance runs premium — bid early.",        state: "Rajasthan",         tags: ["Lakes", "Romance", "Palace"] },
  Jaisalmer:    { emoji: "🐪", photo: "https://picsum.photos/seed/Jaisalmer/240/240",   avg: 3800, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Desert-camp season peaks in winter — bid ahead.",      state: "Rajasthan",         tags: ["Desert", "Fort", "Camp"] },
  Pushkar:      { emoji: "🎡", photo: "https://picsum.photos/seed/Pushkar/240/240",     avg: 2600, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Fair season spikes prices — weekdays otherwise save.", state: "Rajasthan",         tags: ["Fair", "Spiritual", "Lake"] },
  Neemrana:     { emoji: "🏰", photo: "https://picsum.photos/seed/Neemrana/240/240",    avg: 4000, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Weekend fort-palace getaway — bid early for value.",   state: "Rajasthan",         tags: ["Fort", "Heritage", "Weekend"] },
  Goa:          { emoji: "🏖️", photo: "https://picsum.photos/seed/Goa/240/240",         avg: 4000, demand: "Very High", demandColor: "text-red-600    bg-red-50    border-red-200",    tip: "Beach-season premium — bid smart on peak weekends.",   state: "Goa",               tags: ["Beach", "Nightlife", "Party"] },
  Kerala:       { emoji: "🌴", photo: "https://picsum.photos/seed/Kerala/240/240",      avg: 3500, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Backwater season lifts rates — bid ahead of holidays.",state: "Kerala",            tags: ["Backwaters", "Houseboat", "Nature"] },
  Coorg:        { emoji: "☕", photo: "https://picsum.photos/seed/Coorg/240/240",       avg: 3000, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Coffee-country calm — weekdays give the best deals.",  state: "Karnataka",         tags: ["Coffee", "Hills", "Nature"] },
  Leh:          { emoji: "🏔️", photo: "https://picsum.photos/seed/Leh/240/240",         avg: 3200, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Short high-altitude season — bid early in summer.",    state: "Ladakh",            tags: ["Mountains", "Monastery", "Adventure"] },
  Mathura:      { emoji: "🪈", photo: "https://picsum.photos/seed/Mathura/240/240",     avg: 1900, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Pilgrim town — festival dates peak, else great value.",state: "Uttar Pradesh",     tags: ["Spiritual", "Krishna", "Temples"] },
  Vrindavan:    { emoji: "🙏", photo: "https://picsum.photos/seed/Vrindavan/240/240",   avg: 2000, demand: "Medium",    demandColor: "text-amber-600  bg-amber-50  border-amber-200",  tip: "Temple-town demand spikes on festivals — bid early.",  state: "Uttar Pradesh",     tags: ["Spiritual", "Temples", "Pilgrimage"] },
  Ayodhya:      { emoji: "🛕", photo: "https://picsum.photos/seed/Ayodhya/240/240",     avg: 2200, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "High pilgrim demand — bid early for the best rates.",  state: "Uttar Pradesh",     tags: ["Spiritual", "Ram Mandir", "Pilgrimage"] },
  Varanasi:     { emoji: "🪔", photo: "https://picsum.photos/seed/Varanasi/240/240",    avg: 2400, demand: "High",      demandColor: "text-orange-600 bg-orange-50 border-orange-200", tip: "Ghat-side stays peak on festivals — bid ahead.",       state: "Uttar Pradesh",     tags: ["Ghats", "Spiritual", "Ganga"] },
};
