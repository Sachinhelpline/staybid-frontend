...
export default function BookingsPage() {
  ...
  const styleBlock = (
    <style>{`
      ...
      .bk-gold-btn { position:relative; overflow:hidden; background:linear-gradient(135deg,#748da6 0%,#a9b9c8 48%,#cbd5de 60%,#8198ae 100%); color:#1a1205; font-weight:800; letter-spacing:.03em; }
    `}</style>
  );
