...
// v284 — investment slabs aligned to the 5-phase journey master spec.
// Keys stay stable (adventurer/trailblazer) — only names + bands changed.
export const HOST_BUDGET_TIERS: HostBudgetTier[] = [
  {
    key: "explorer",
    name: "Explorer",
    invest: "₹20K–₹50K",
    investNote: "monthly budget · first-time investors",
    rooms: "1–3 rooms access",
    cities: "1–2 cities",
    expectedReturn: "18–24% p.a.",
    accent: "#0d9488",
    perks: [
      "Rooms set up & listed for you",
  ...
  },
  {
    ...
    name: "Growth",
    invest: "₹50K–₹1L",
    investNote: "monthly budget · growth focused",
    rooms: "3–8 rooms access",
    cities: "2–5 cities",
    expectedReturn: "20–28% p.a.",
    accent: "#2563eb",
    perks: [
      "Multi-room, multi-city footprint",
  ...
  },
  {
    ...
    name: "Premium",
    invest: "₹1L–₹2L",
    investNote: "monthly budget · serious investors",
    rooms: "8–15 rooms access",
    cities: "5–10 cities",
    expectedReturn: "22–32% p.a.",
    accent: "#7c3aed",
    perks: [
  ...
  },
  {
    ...
    name: "Elite",
    invest: "₹2,00,000+",
    investNote: "monthly budget · high net worth",
    rooms: "15+ rooms access",
    cities: "10+ cities",
    expectedReturn: "24–36% p.a.",
    accent: "#c9911a",
    perks: [
      "Large multi-city portfolio",
