  ...
  return (
    <>
      <style>{`
        ...
        @keyframes navPulse { 0%,100% { box-shadow: 0 0 0 0 rgba(109,140,86,0.5), inset 0 1px 0 rgba(255,255,255,0.3); } 50% { box-shadow: 0 0 18px 2px rgba(109,140,86,0.45), inset 0 1px 0 rgba(255,255,255,0.3); } }
        ...
        .nav3d-eq {
          ...
          border: 1px solid rgba(109,140,86,0.42) !important;
        ...
        .nav3d-eq:hover {
          ...
          border-color: rgba(109,140,86,0.75) !important;
          color: #241a0b !important;
          box-shadow:
            0 9px 22px rgba(109,140,86,0.30),
        ...
        .nav3d-eq.nav3d-chip-active {
          background: linear-gradient(135deg, #8ead79 0%, #6d8c56 55%, #4e653e 100%) !important;
          border-color: rgba(255,255,255,0.4) !important;
          color: #1f1a0f !important;
          box-shadow:
            0 4px 14px rgba(109,140,86,0.42),
            inset 0 1px 0 rgba(255,255,255,0.55),
            inset 0 -2px 0 rgba(78,101,62,0.22) !important;
        }
        ...
        [data-theme="dark"] .nav3d-eq:hover {
          ...
          border-color: rgba(109,140,86,0.62) !important;
          color: #fff6e2 !important;
          box-shadow:
            0 10px 24px rgba(109,140,86,0.24),
        ...
        [data-theme="dark"] .nav3d-solidgold {
          background: linear-gradient(135deg, #8ead79 0%, #6d8c56 52%, #4e653e 100%) !important;
          border: 1px solid rgba(255,255,255,0.45) !important;
          color: #1f1a0f !important;
          box-shadow:
            0 3px 13px rgba(109,140,86,0.42),
            inset 0 1px 0 rgba(255,255,255,0.6),
            inset 0 -2px 0 rgba(78,101,62,0.28) !important;
        }
        .nav3d-solidgold:hover,
        [data-theme="dark"] .nav3d-solidgold:hover {
          color: #1f1a0f !important;
          box-shadow:
            0 10px 26px rgba(109,140,86,0.55),
        ...
        .nav3d-row:hover { background: rgba(109,140,86,0.10) !important; }
        ...
        @keyframes dockPulse {
          0%, 100% { box-shadow: 0 6px 20px rgba(109,140,86,0.45), 0 0 0 0 rgba(109,140,86,0.45), inset 0 1px 0 rgba(255,255,255,0.4); }
          50%      { box-shadow: 0 8px 28px rgba(109,140,86,0.55), 0 0 0 6px rgba(109,140,86,0), inset 0 1px 0 rgba(255,255,255,0.4); }
        }
        @keyframes dockRing {
        ...
        .dock::before {
          ...
          content: ""; position: absolute; inset: 0;
          border-radius: 999px;
          background: linear-gradient(180deg, rgba(109,140,86,0.18) 0%, transparent 30%);
          pointer-events: none;
          opacity: 0.55;
        }
        ...
        .dock-btn.is-active {
          color: #fff;
          background:
            radial-gradient(circle at 50% 50%, rgba(109,140,86,0.35) 0%, rgba(109,140,86,0.05) 70%);
        }
        .dock-btn.is-active .dock-btn-icon {
          transform: translateY(-3px) scale(1.18);
          filter: drop-shadow(0 4px 8px rgba(109,140,86,0.55));
        }
        ...
        .dock-btn.is-active::after {
          ...
          border-radius: 50%;
          background: linear-gradient(135deg, #85a66e, #64814f);
          box-shadow: 0 0 8px #a7bf96, 0 0 14px rgba(109,140,86,0.55);
        ...
        .dock-fab {
          ...
          margin: 0 -2px;
          background: linear-gradient(135deg, #85a66e 0%, #64814f 55%, #4e653e 100%);
          color: #1a1208;
          border-radius: 50%;
          box-shadow:
            0 10px 26px rgba(109,140,86,0.45),
            0 4px 10px rgba(0,0,0,0.4),
            inset 0 2px 0 rgba(255,255,255,0.5),
            inset 0 -2px 0 rgba(78,101,62,0.3);
                ...
                <Link key={item.href} href={item.href}
                  ...
                  {isReels && !active && (
                    <span className="ml-0.5 text-[0.55rem] font-black px-1.5 py-0.5 rounded-full"
                      style={{ background: "linear-gradient(135deg,#64814f,#6d8c56)", color: "#000" }}>
                      NEW
                    </span>
                  )}
                </Link>
              ...
              <>
                    ...
                    <>
                      ...
                      <div
                        ...
                        style={{
                          ...
                          border: "1px solid var(--border-strong, rgba(109,140,86,0.28))",
                      ...
                      >
                        ...
                        <button
                          ...
                          style={{ color: "var(--accent, #a7bf96)", background: "rgba(109,140,86,0.06)", borderBottom: "1px solid rgba(109,140,86,0.14)" }}
                          role="menuitem"
                        >
                        ...
                        {userLinks.map((item: any) => {
                          ...
                          return (
                            <Link
                              ...
                              style={{
                                color: active ? "var(--accent, #a7bf96)" : "var(--text-soft, rgba(255,255,255,0.78))",
                                background: active ? "rgba(109,140,86,0.10)" : "transparent",
                                borderLeft: active ? "2px solid var(--accent, #a7bf96)" : "2px solid transparent",
                              }}
                            >
                        ...
                        <button
                          ...
                          onClick={toggleTheme}
                          className="nav3d-row flex items-center gap-3 px-3.5 py-2.5 w-full text-left text-[0.82rem] font-semibold"
                          style={{ color: "var(--text-base, #1F1A0F)", borderTop: "1px solid rgba(109,140,86,0.14)" }}
                          role="menuitem"
                        >
                ...
                <Link href="/profile"
                  ...
                  <div className="rounded-full flex items-center justify-center text-white text-[0.62rem] font-bold shrink-0"
                    style={{ width: 26, height: 26, background: "linear-gradient(135deg,#64814f,#6d8c56)", boxShadow: "inset 0 1px 0 rgba(255,255,255,0.3)" }}>
          ...
          <div className="md:hidden flex items-center gap-2">
            {user ? (
              <Link href="/profile"
                ...
                style={{ background: "linear-gradient(135deg,#64814f,#6d8c56)", boxShadow: "0 3px 12px rgba(109,140,86,0.4), inset 0 1px 0 rgba(255,255,255,0.3)" }}>
                {(user.name || user.phone || "S").slice(0, 2).toUpperCase()}
              </Link>
            ) : (
      ...
      {moreOpen && (
        <>
          ...
          <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 sheet-in"
            style={{ background: "linear-gradient(180deg,#12101c,#0a0812)", borderRadius: "24px 24px 0 0", boxShadow: "0 -12px 50px rgba(0,0,0,0.7)", border: "1px solid rgba(109,140,86,0.25)" }}>
            ...
            <div className="px-4 py-4">
              ...
              <button
                ...
                style={{ background: "linear-gradient(135deg,rgba(201,166,107,0.16),rgba(109,140,86,0.10))", border: "1px solid rgba(109,140,86,0.3)" }}
              >
                <span className="w-10 h-10 rounded-xl flex items-center justify-center text-lg shrink-0" style={{ background: "linear-gradient(135deg,#64814f,#6d8c56)", color: "#1F1A0F" }}>⇅</span>
                ...
                <div className="space-y-2">
                  <Link href="/profile" onClick={() => setMoreOpen(false)}
                    ...
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center text-white font-bold text-sm shrink-0"
                      style={{ background: "linear-gradient(135deg,#64814f,#6d8c56)", boxShadow: "inset 0 1px 0 rgba(255,255,255,0.3)" }}>
                      {(user.name || user.phone || "S").slice(0, 2).toUpperCase()}
                    </div>
                    <div className="flex-1 min-w-0">
