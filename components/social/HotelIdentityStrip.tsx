  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: "radial-gradient(88% 64% at 32% 4%,rgba(255,255,255,0.5),transparent 58%),linear-gradient(160deg,#e6edf3 0%,#c9d4df 52%,#a4b5c6 100%)", border: "1.5px solid rgba(255,255,255,0.5)" }}
      >
